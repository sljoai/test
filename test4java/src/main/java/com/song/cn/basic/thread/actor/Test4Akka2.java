...
public class Test4Akka2 {
    ...
    private static class Greeter2 extends AbstractActor {
        private final String myName;
        private final String greeting;

        Greeter2(String name, String greeting) {
            myName = name;
            this.greeting = greeting;
        ...
        public static Props props(String name, String greeting) {
            return Props.create(Greeter2.class, name, greeting);
        }
    }
}